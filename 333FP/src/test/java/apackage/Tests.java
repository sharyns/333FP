...
import apackage.Computer;
import apackage.CreditCard;
import apackage.Driver;
import apackage.Kiosk;
import apackage.Order;
import apackage.Payment;
import apackage.Shops;
...
public class Tests {
	...
	public void testPayment() {
		...
		method.pay(11.11);
		assertEquals(method.toString().trim(), 10);
	}
